...
var bookingService = new BookingService(reservationStore, roomStore, emailSender);
var billingService = new BillingService(reservationStore, roomStore);
var housekeepingScheduler = new HousekeepingScheduler(
    reservationStore, CleaningPolicyFactory.CreateStandard(), smsSender);
